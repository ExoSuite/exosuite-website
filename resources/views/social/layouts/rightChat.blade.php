    ...
    <div class="fixed-sidebar-right sidebar--small" id="sidebar-right">
        ...
        <div class="mCustomScrollbar" data-mcs-theme="dark">
            <ul class="chat-users">
                ...
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar62-sm.jpg" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
                </li>
                ...
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar68-sm.jpg" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
                </li>
                ...
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar69-sm.jpg" class="avatar">
                ...
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar70-sm.jpg" class="avatar">
                        <span class="icon-status disconected"></span>
                    </div>
                </li>
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar64-sm.jpg" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
                </li>
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar71-sm.jpg" class="avatar">
                        <span class="icon-status online"></span>
                    </div>
                </li>
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar72-sm.jpg" class="avatar">
                        <span class="icon-status away"></span>
                    </div>
                </li>
                <li class="inline-items js-chat-open">
                    <div class="author-thumb">
                        <img alt="author" src="/img/social/avatar63-sm.jpg" class="avatar">
