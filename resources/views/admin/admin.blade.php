...
<head>
    ...
    <meta name="google-signin-client_id" content="519325948830-5ogboupur7lpt1abqkm6fb9u05n3hcis.apps.googleusercontent.com">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-red">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{ $commentary }}</span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total utilisateur</span>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="info-box bg-green">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total groupe</span>
                    ...
                    <div class="info-box bg-aqua">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total message</span>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="chart-responsive">
                                        <canvas id="pieChart" height="150" chrome="50" firefox="5" other="2"></canvas>
                                    </div>
                                    <!-- ./chart-responsive -->
                                </div>
                                <!-- /.col -->
                                <div class="col-md-4">
                                    <ul class="chart-legend clearfix">
                                        ...
                                        <li><i class="fa fa-circle-o text-green"></i> Other</li>
